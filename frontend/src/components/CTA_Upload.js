            ...
            <section className="py-14">
                <div className="max-w-screen-xl mx-auto px-4 md:text-center md:px-8">
                    ...
                    <div className="flex gap-3 items-center mt-4 md:justify-center">
                        ...
                        <a href="javascript:void(0)" className="inline-block py-2 px-4 text-white-800 font-medium duration-150 border hover:bg-gray-400 active:bg-gray-100 rounded-lg">
                            Learn more
                        </a>
                    </div>
                </div>
