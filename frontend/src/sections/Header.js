...
const Header = () => {
  ...
  const NavLink = ({ title }) => {
    const handleNavClick = () => {
      navigate("/"); // Navigate to home for every nav link
  ...
  const handleLogoClick = () => {
    navigate("/"); // Navigate to the homepage when the logo is clicked
  };
  ...
  return (
    ...
    >
      <div className="container flex h-14 items-center max-lg:px-5">
        <a className="lg:hidden flex-1 cursor-pointer z-2" onClick={handleLogoClick}>
